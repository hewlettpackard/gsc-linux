...
{
	// whatever happens we need to return an initial value even
	// if postcode == 0 and previouspostcode == 0
...
static int gxp_dbg_probe(struct platform_device *pdev)
{
	...
	drvdata->powergood_thread = kthread_run(wait_power_transition, NULL,
